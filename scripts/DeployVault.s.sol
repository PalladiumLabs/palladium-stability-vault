...
contract DeployVault is Script {
   ...
   //address public router = 0xA5E0AE4e5103dc71cA290AA3654830442357A489;
    ...
    address public vault = 0x4C52b0A03E1Da8DDCfbECa073962B26002403213;
    address public strat = 0x32c25e90e50990A05cD5DEa3B7b755ABE51790B5;
    ...
    function run() external {
        uint256 deployerPrivateKey = 0x0000;
        address deployer = vm.addr(deployerPrivateKey);
        vm.startBroadcast(deployerPrivateKey);
        console.log("Deploying contracts with account:", deployer);

    //     RiveraAutoCompoundingVaultV2Public vault = new RiveraAutoCompoundingVaultV2Public(pusd , "Pall-Vault", "Pall-Vault",1000e18,1000000e18);
